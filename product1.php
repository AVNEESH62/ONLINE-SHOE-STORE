	...
	<div id="carousel" style=" width:1200px;height: 400px;" >
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner1" style=" width:1200px;">
					<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/nike-colorways-october-2019-1-1200x628.jpg" class="carousel" ></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/2017-cat-banner-bball-foot-lp.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/150807_ADH_LP_FEATURE_CURRYDROP_TRIPLEBLACK.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/footwear-turbine-turf-banner-2.jpg" class="carousel"></div>
				</div>
