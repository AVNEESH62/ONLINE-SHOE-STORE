...
if (isset($_SESSION['cart']))
	...
	$total=0;
	foreach($_SESSION['cart'] as $id => $oqty)
	{
	...
	$total= $total + $line_cost;
		...
		echo "<td><h4><input type='hidden' required value='".$oqty."' name='qty[]'> ".$oqty."</h4></td>";
		...
		echo "<td><strong><h3>Rs ".$line_cost."</h3></strong></td>";
		echo "</tr>";
		}
