	...
	<div id="carousel" style=" width:1200px;height: 400px;" >
		<div id="myCarousel" class="carousel slide">
			<div class="carousel-inner1" style=" width:1200px;">
					<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/4e3142435b7a0a2f5f1229db876c7ed4.jpg" class="carousel" ></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/fa4596ad9a9d39901eeb455ed4f74e44.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/lp-ladies-footwear-2017-banner-4.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner/banner-1.jpg" class="carousel"></div>
				</div>
